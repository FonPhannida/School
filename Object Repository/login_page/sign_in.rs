...
<WebElementEntity>
   ...
   <selectorCollection>
      <entry>
         <key>BASIC</key>
         <value>//hierarchy/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.webkit.WebView[1]/android.webkit.WebView[1]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[2]/android.view.View[2]/android.view.View[5]/android.widget.Button[1][count(. | //*[@class = 'android.widget.Button' and @instance = '1' and (text() = 'SIGN IN ' or . = 'SIGN IN ')]) = count(//*[@class = 'android.widget.Button' and @instance = '1' and (text() = 'SIGN IN ' or . = 'SIGN IN ')])]</value>
      </entry>
   </selectorCollection>
