...
Mobile.setText(findTestObject('register/edit_text_field'), 'S5009', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('register/activate_account_button'), 0)

Mobile.waitForElementPresent(findTestObject('review_profile/review_profile_page'), 0)

Mobile.verifyElementExist(findTestObject('review_profile/children_section'), 0)

Mobile.verifyElementText(findTestObject('review_profile/parent_phone'), '0819117591')
