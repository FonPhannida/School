...
Mobile.startApplication('kobiton-store:12916', true)
...
Mobile.verifyElementExist(findTestObject('register/verifycode_input_field'), 0)

Mobile.tap(findTestObject('register/back_arrow_button'), 0)
